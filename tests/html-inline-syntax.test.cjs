...
assert.match(html,/<script src="\.\/app\.js\?v=93-responsive-function-parity"><\/script>/);
assert.match(html,/<link rel="stylesheet" href="\.\/app\.css\?v=93-responsive-function-parity">/);
