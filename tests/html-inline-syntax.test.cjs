...
assert.match(html,/<script src="\.\/app\.js\?v=90-subdoelen-en-afschrijving"><\/script>/);
assert.match(html,/<link rel="stylesheet" href="\.\/app\.css\?v=90-subdoelen-en-afschrijving">/);
